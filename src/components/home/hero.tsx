    ...
    <section className="container mx-auto py-8 sm:py-12 md:py-16 lg:py-12 text-center relative overflow-hidden px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="mx-auto max-w-6xl relative z-10">
       ...
       <div className="mb-6 sm:mb-8 md:mb-10 flex justify-center">
        <Link href="/patterns" className="inline-flex">
          <div
            className={`gap-2 py-2 px-3 sm:px-4 text-xs sm:text-sm rounded-full shadow-lg backdrop-blur-md transition-all duration-300 border flex items-center ${
              isPatternDark
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold font-mono -tracking-tight mb-1 sm:mb-3">
            <span
